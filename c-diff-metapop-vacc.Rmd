...
$$
  ...
  \left[
    \begin{array}
      {ccc}
      d_1+\xi_1^L+\phi_1^L+(\delta+d_2)\frac{N_2}{N_1} & -\delta & -\rho_C & 0 \\
      -(1-r_C)(\delta+d_2)\frac{N_2}{N_1} & d_2+\xi_2^L+\phi_2^L+\delta & 0 & 0 \\
      0 & 0 & d_1+\xi_1^H+\phi_1^H+(\delta+d_2)\frac{N_2}{N_1}+\rho_C & -\delta \\
      -r_C(\delta+d_2)\frac{N_2}{N_1} & 0 & -(\delta+d_2)\frac{N_2}{N_1} & d_2+\xi_2^H+\phi_2^H+\delta
    \end{array}
  \right],
$$
